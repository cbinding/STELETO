...
namespace STELETO
{
    ...
    /// This class derived from https://github.com/22222/CsvTextFieldParser
    /// </remarks>
    public class DelimitedTextFieldParser : IDisposable
    {
        ...
        /// </summary>
        public DelimitedTextFieldParser(Stream stream)
            : this(new StreamReader(stream)) { }

        /// <summary>
        /// Constructs a parser from the specified input stream with the specified encoding. 
        /// </summary>
        public DelimitedTextFieldParser(Stream stream, Encoding encoding)
        ...
        /// </summary>
        public DelimitedTextFieldParser(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks)
        ...
        /// </summary>
        public DelimitedTextFieldParser(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks, bool leaveOpen)
            : this(new StreamReader(stream, encoding, detectEncodingFromByteOrderMarks))
        {
        ...
        /// </summary>
        public DelimitedTextFieldParser(string path, Encoding encoding, bool detectEncodingFromByteOrderMarks)
        ...
        /// </summary>
        public DelimitedTextFieldParser(TextReader reader)
        {
        ...
        /// <summary>
        /// Closes the current <see cref="DelimitedTextFieldParser"/> object.
        /// </summary>
        public void Close()
        {
            if (reader != null)
        ...
        /// <summary>
        /// Closes and disposes the current <see cref="DelimitedTextFieldParser"/> object.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
        ...
        /// <summary>
        /// Disposes of the current <see cref="DelimitedTextFieldParser"/> object. 
        /// </summary>
    ...
    /// <summary>
    /// An exception that is thrown when the <see cref="DelimitedTextFieldParser.ReadFields"/> method cannot parse a row using the specified format.
    /// </summary>
    /// <remarks>
